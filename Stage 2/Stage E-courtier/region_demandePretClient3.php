...
?>
    <div id="container">
        <form id="SignupForm" action="../bkpe/controler/region_formPret.php?id=<?php echo $id_partenaire; ?>" class="form-horizontal" method="post">

            <fieldset>
                <legend> Objet</legend><hr>
                <label for="compromis">Quel type de prêt recherchez-vous ? </br></br></label>
                    <span>
                        <input name="compromis" id="radio1" type="radio" value="signé" class="aaa" checked="checked" >
        ...
        <fieldset>
            ...
            <div id="budget">
				...
				<div id="remplir">
					...
					<input id="apport" class="nombre" type="text" name="apport" value="0 - A determiner" onclick="apport.value=''" /> €
				</div>
				<div id="remplir">
				...
				<div id="remplir">
					<label for="achat">Vous achetez :</label>
						<span>
							<input name="achat" id="radio12" type="radio" value="Terrain seul" class="aaa" checked="checked" >
				...
				<div id="remplir">
					<label for="CreditcardMonth">Usage de l'achat :</label>
						<span>
							<input name="usage" id="radio13" type="radio" value="Principale" class="selecteur" checked="checked" >
            ...
            <fieldset>
				...
				<div id="remplir">
					...
					<span>
						<input name="m_mme_mlle" id="radio17" type="radio" value="Monsieur" class="selecteur" checked="checked" >
				...
				<div id="remplir">
					...
					<input id="nom" name="nom" value="<?php echo $nom; ?>" class="nombre" type="text" />
				</div>
				<div id="remplir">
					<label for="prenom">Prénom</label>
					<input id="prenom" value="<?php echo $prenom; ?>" class="nombre" type="text" name="prenom" class="chaine"/>
				</div>
				<div id="remplir">
					<label for="dateNaissance">Date de naissance</label>
					<input id="dateNaissance" type="date" name="dateNaissance" class="nombre" />                
				</div>
				...
				<div id="remplir">
					<label for="situation">Situation matrimoniale</label>
						<span>
							<input name="situation" id="radio14" type="radio" value="Celibataire" class="selecteur" checked="checked" >
				...
				<div id="remplir">
					<label for="enfants">Nombre enfants à charges</label>
						<span>
							<input name="enfants" id="radio15" type="radio" value="0" class="selecteur" checked="checked" >
			...
			<div id="remplir">
                ...
                <input id="adresse" name="adresse"  class="nombre" type="text" />
			</div>
			<div id="remplir">
                <label for="codePostal">Code postal</label>
                <input id="codePostal" class="nombre" type="text" name="codePostal"/>
			</div>
			<div id="remplir">
                <label for="ville">Ville</label>
                <input id="ville" name="ville"  class="nombre" type="text" />
			</div>
            </fieldset>
