...
////////////////////////////////////////////////////////////// controle non logé     
    ...
    try{
      $save = $bdd->prepare("INSERT INTO clients "
        . "(timekape, timekape_last_modif, m_mme_mlle, nom, prenom, email, portable, adresse,code_postal,ville,mdp )"
        . " VALUES(:timekape, :timekape_last_modif, :m_mme_mlle, :nom,:prenom,:email,:portable,:adresse,:code_postal,:ville,:mdp)");
...
try {
    $save2 = $bdd->prepare("INSERT INTO dossiers_bkpe  (id_client, timekape,timekape_last_modif, categorie, statut, delai, achat, invest, travaux, apport,fin_pret,notaire,agence,provenance )"
        . " VALUES(:id_client, :timekape, :timekape_last_modif, :categorie,:statut,:delai,:achat,:invest,:travaux,:apport,:fin_pret,:notaire,:agence,:provenance)");
    if ( $email_controle !==""){
