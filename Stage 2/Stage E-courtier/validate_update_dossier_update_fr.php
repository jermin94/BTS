...
&nbsp;&nbsp;id client :  &nbsp;
<?php echo $id_client ; ?>  &nbsp; &nbsp; <?php echo $tel ; ?>&nbsp; - &nbsp; <?php echo $portable ; ?> &nbsp; - &nbsp; <?php echo $timekape_client ; ?>
</li>
...
- 
<a href="./2016_demande_banques.php?id=<?php echo $id ;   ?>"><span style="font-size: 12px; font-weight: bold;"><?php echo "Carcasse Banque "   ?></span></a>
...
<a href="./validate_pret.php?timekape=<?php echo $timekape ;   ?>"><span style="font-size: 12px; font-weight: bold;"><?php echo "Modifier le dossier "   ?></span></a>
...
if   (  $categorie=="Parrainage"    )   {  echo "Parrainage" ;   }
...
<option value="dossier_au_SAV" <?php  if   (  $statut=="dossier_au_SAV"    )   {  echo "selected" ;   }  ?>  >Dossier au SAV</option>
...
<option value="Epargne_suivi" <?php  if   (  $statut=="Epargne_suivi"    )   {  echo "selected" ;   }  ?>  >Epargne : Suivi Annuel</option>
...
<option value="Parrainage_valide" <?php  if   ( $statut=="Parrainage_valide"  )   {  echo "selected" ;   }  ?>  >Parrainage valide</option>

<option value="Parrainage_dossier_en_cours" <?php  if   ( $statut=="Parrainage_dossier_en_cours"  )   {  echo "selected" ;   }  ?>  >Parrainage dossier en cours</option>

<option value="Parrainage_dossier_finalise" <?php  if   ( $statut=="Parrainage_dossier_finalise"  )   {  echo "selected" ;   }  ?>  >Parrainage dossier finalis&eacute; </option>

<option value="Parrainage_dossier_paye" <?php  if   ( $statut=="Parrainage_dossier_paye"  )   {  echo "selected" ;   }  ?>  >Parrainage dossier pay&eacute; </option>
...
<div class="bkpe_annonce_input">
<?php
echo $nom."  ".$prenom ; " ".$telephone ; "  ".$portable ;
?>
...
(visible client et envoi email) Nouveau message  :
</div>
<div class="bkpe_annonce_input">
