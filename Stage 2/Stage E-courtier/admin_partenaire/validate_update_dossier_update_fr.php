...
else
{
  ...
  echo '<br><br>Suivi de  <b>'.safest($_SESSION['pseudo']).'</b>';
...
<option value="Credit_:_Proposition_recue" <?php  if   (  $statut=="Credit_:_Proposition_recue"    )   {  echo "selected" ;   }  ?>  >Credit : Proposition reçue</option>


<option value="Credit_:_Rdv_client_banque" <?php  if   (  $statut=="Credit_:_Rdv_client_banque"    )   {  echo "selected" ;   }  ?>  >Credit : Rdv client à la banque</option>
...
<option value="Credit_:_Pret_débloque" <?php  if   (  $statut=="Credit_:_Pret_debloque"    )   {  echo "selected" ;   }  ?>  >Credit : Pret debloqué</option>
...
<option value="Loyers_sinistre_en_cours" <?php  if   (  $statut=="Loyers_sinistre_en_cours"    )   {  echo "selected" ;   }  ?>  >Loyers Sinistre en cours</option>
