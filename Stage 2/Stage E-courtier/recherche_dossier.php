...
$connect = $_COOKIE;
	...
	$i=0;
	$result_1 = mysql_query("SELECT * FROM dossiers_bkpe where id='$dossier'");
	...
	$i=i+1;
...

			{
				...
				$idT=$row_kpe_1->id_client;
				$result_1 = mysql_query("SELECT * FROM clients where id='$idT'");
				$row_kpe_1 = mysql_fetch_object ($result_1);
				...
				$result_1 = mysql_query("SELECT * FROM dossiers_bkpe where id='$dossier'  order by timekape_last_modif desc");
				$nbr_analyse=mysql_num_rows($result_1) ;
