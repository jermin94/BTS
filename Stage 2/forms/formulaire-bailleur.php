...
$(function(){
    ...
    $("mail_util").change(function(){
        ...
        $.post("verifemail.php", { "valeurSaisie" :  saisie })
            .done(function(data){
                 // cette fonction est executée au succès de l'appel ajax
                 // => elle prend en param le contenu de la réponse
                 if (data == 1) {
                 	document.getElementById("webcontainer2").innerHTML = 'Attention : cet email a déjà été ajouté' ;
                 }
                 else if (data == 2) {
                 	document.getElementById("webcontainer2").innerHTML = ' ';
                 }
            })
            .fail(function(){
