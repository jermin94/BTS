...
<body >
    <div id="container">
        <form id="SignupForm" action="../bkpe/controler/formPret_partenaire.php" class="form-horizontal" method="post">
            ...
            <fieldset>
                ...
                <label for="compromis">Quel type de prêt recherchez-vous ? </br></br></label>
                    ...
                    <input name="compromis" id="radio6" type="radio" value="SCPI" class="aaa">
                        <label for="radio6">SCPI</label>
                    </span>
                    <span>
            <br>
        ...
        <fieldset>
            ...
            <div id="budget">
				...
				<div id="remplir">
					<label for="achat">Vous achetez :</label>
						...
						<span>
							<input name="achat" id="radio62" type="radio" value="SCPI" class="aaa">
							<label for="radio62">SCPI</label>
						</span>
				</div>
                <!--usage-->
				<div id="remplir">
			...
			<div id="remplir">
					<label for="m_mme_mlle">Titre</label>
						<span>
            ...
            <fieldset>
                ...
                <div class="id_region">
                    <label for="id_region">Interlocuteur et type contact :</label>
					<select id="id_region" name="id_region"> 
						<option value="2">Nord - T Lemaire</option>
						<option value="40">Nord - V Deloison</option>
						<option value="9">Nord - AF Grymomprez</option>
						<option value="32">Aquitaine - E Eggert</option>
						<option value="41">Ariege -L Beaufils</option>
						<option value="18">Besançon - R Amoureux</option>
					...
					<select id="provenance" name="provenance"> 
						...
						<option value="Fiche Fournie">Fiche Fournie</option>
						<option value="Autres">Autres</option>
					</select>   
				</div>
