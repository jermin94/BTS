...
<body >
    <div id="container">
        <form id="SignupForm" action="../bkpe/controler/formPret_scpi.php" class="form-horizontal" method="post">

            <fieldset>
                <legend> Votre investissement SCPI</legend><hr>
                <label for="compromis">Avez vous déjà choisi une SCPI ? </br></br></label>
                    <span>
                        <input name="compromis" id="radio1" type="radio" value="Oui" class="aaa">
                        <label for="radio1">SCPI deja choisie</label>
                    </span>
                    <span>
                        <input name="compromis" id="radio2" type="radio" value="choix en etude" class="aaa">
                        <label for="radio2">Non, pas encore choisie</label>
                    </span>
                    <span>
                        <input name="compromis" id="radio3" type="radio" value="A determiner" class="aaa">
                        <label for="radio3">A determiner</label>
                    </span>
                    <span>
            ...
            <div class="recherche" style="display: none;">
                <div class="bs-example">
                    <p><br><b>Voulez-vous une aide sans engagement de nos partenaires dans la recherche de votre SCPI ?</b><br>
                    ...
                    <div id="rechercheInput" style="display:none;">
                        <label for="recherche">Merci de nous indiquer vos disponibilités :</label>
        ...
        <fieldset>
            <legend>Budget et Objectif</legend>
            <div id="budget">
				<div id="remplir">
					<label for="investissement">Quel montant de SCPI envisagez vous investir?</label>
				...
				<div id="remplir">
					<label for="achat">Vous achetez :</label>
						<span>
							<input name="achat" id="radio12" type="radio" value="Primopierre" class="aaa">
							<label for="radio12">Primopierre</label>
						</span>
						<span>
							<input name="achat" id="radio22" type="radio" value="Primovie" class="aaa">
							<label for="radio22">Primovie</label>
						</span>
						<span>
							<input name="achat" id="radio32" type="radio" value="Immorente" class="aaa">
							<label for="radio32">Immorente</label>
						</span>
						<span>
							<input name="achat" id="radio42" type="radio" value="Autre SCPI" class="aaa">
							<label for="radio42">Autre SCPI</label>
						</span>
                ...
                <!--usage-->
				<div id="remplir">
					<label for="CreditcardMonth">Finalité de l'opération :</label>
						<span>
						
						<span>
							<input name="usage" id="radio18" type="radio" value="constitution_patrimoine" class="selecteur">
							<label for="radio18">Se constituer un patrimoine à crédit</label>
						</span>
							<span>
							<input name="usage" id="radio28" type="radio" value="diversifier_patrimoine" class="selecteur">
							<label for="radio28">Diversifier son patrimoine</label>
						</span>
							<span>
							<input name="usage" id="radio38" type="radio" value="Besoin_revenus" class="selecteur">
							<label for="radio38">Besoin de revenus à terme</label>
						</span>
...
<script type="text/javascript" src="formulairePret_SCPI.js"></script>
