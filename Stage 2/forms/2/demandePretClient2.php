...
<body >
    <div id="container">
        <form id="SignupForm" action="formPret.php" class="form-horizontal" method="post">
            ...
            <fieldset>
                <legend> Avancement de votre projet</legend><hr>
                <label for="compromis">Où en êtes-vos dans votre projet ? </br></br></label>
                    <span>
                    ...
                    <span>
                        ...
                        <label for="radio3">Sous 3 mois</label>
                    </span>
                    <span>
        ...
        <fieldset>
            <legend>Détaillez-nous votre projet :</legend>
     	...
     	<div id="remplir">
					<label for="achat">Vous souhaitez acheter :</br></br></label>
                    <span>
                        <input name="achat" id="radio1" type="radio" value="Terrain seul" class="aaa">
                        <label for="radio1">Terrain seul</label>
                    </span>
                    <span>
                    
                      <input name="achat" id="radio1" type="radio" value="Achat Ancien" class="aaa">
                        <label for="radio2">Achat Ancien</label>
                    </span>
                    <span>
                      <input name="achat" id="radio1" type="radio" value="Construction" class="aaa">
                        <label for="radio3">Construction</label>
                    </span>
                    <span>
                      <input name="achat" id="radio1" type="radio" value="Revente + Nvelle Acquisition" class="aaa">
                        <label for="radio4">Revente + Acquisition</label>
                    </span>
                    <span>
                      <input name="achat" id="radio1" type="radio" value="Travaux uniquement" class="aaa">
                        <label for="radio5">Travaux Uniquement</label>
                    </span>
                    <span>
					
	    <!--usage-->
				<div id="remplir">
					<label for="CreditcardMonth">Votre acquisition, c'est pour :</label>
					
					  <input name="usage" id="radio1" type="radio" value="Residence Principale" class="aaa">
                        <label for="radio1">Residence Principale</label>
                    </span>
                    <span>
                      <input name="usage" id="radio2" type="radio" value="Residence Secondaire" class="aaa">
                        <label for="radio1">Residence Secondaire</label>
                    </span>
                    <span>
                      <input name="usage" id="radio3" type="radio" value="Inv. Locatif" class="aaa">
                        <label for="radio1">Inv. Locatif</label>
                    </span>
                    <span>
				...
				<div id="remplir">
					<label for="montantTravaux">Montant des travaux / construction :</label>
				...
				<div id="remplir">
                    <label for="valeurBienActu">Si vous êtes  propriétaire, quelle est la valeur de votre bien actuel :</label>
        ...
        <br>       <p><b> .</b></P>     </div>
            ...
            <fieldset>
				...
				<div id="remplir">
					...
					<input type="mail" id="email" name="email" type="text" onblur="verifMail()" />
				 	...
				 	<div id="remplir">
					<label for="mr_mme_mlle">Titre :</label>
				
				
				 <input name="mr_mme_mlle" id="radio2" type="radio" value="Monsieur" class="aaa">
                        <label for="radio1">Monsieur</label>
                    </span>
                    <span>
					
				 <input name="mr_mme_mlle" id="radio2" type="radio" value="Madame" class="aaa">
                        <label for="radio">Madame</label>
                    </span>
                    <span>
                    <input name="mr_mme_mlle" id="radio3" type="radio" value="Mlle" class="aaa">
                        <label for="radio3">Mademoiselle</label>
				...
				<div id="remplir">
					<label for="enfants">Nombre enfants à charge :</label>
					
					
					  <input name="enfants" id="radio1" type="radio" value="0" class="aaa">
                        <label for="radio1">0</label>
                    </span>
                    <span>
					
					  <input name="enfants" id="radio2" type="radio" value="1" class="aaa">
                        <label for="radio1">1</label>
                    </span>
                    <span>
					
					  <input name="enfants" id="radio3" type="radio" value="2" class="aaa">
                        <label for="radio1">2</label>
                    </span>
                    <span>
                     <input name="enfants" id="radio4" type="radio" value="3" class="aaa">
                        <label for="radio1">3</label>
                    </span>
                    <span>
                     <input name="enfants" id="radio5" type="radio" value="4" class="aaa">
                        <label for="radio1">4</label>
                    </span>
                    <span>
                     <input name="enfants" id="radio1" type="radio" value="5" class="aaa">
                        <label for="radio1">5</label>
                    </span>
                    <span>
                     <input name="enfants" id="radio6" type="radio" value="6 et +" class="aaa">
                        <label for="radio1">6 et +</label>
                    </span>
                    <span>
            ...
            <fieldset>
				...
				<div id="remplir">
					...
					<input id="anciennete" class="nombre" type="text" name="anciennete"/> 
				</div>
				<div id="remplir">
                ...
                <br />    
                <br />    
                <button  type="unBouton" id="creerReven">Ajouter un autre revenus</button>
            ...
            <fieldset>
            <legend>Quelle est votre banque ?</legend>
			<div id="remplir">
            ...
            <fieldset>
                ...
                <br> <br>
                <button type="button" id="creerCharges">Ajouter une autre charge</button>*
        ...
        <div id="erreurNonRemplie" class="alert alert-danger alert-dismissible fade in" role="alert" style="width:100%; display: none;">
          <p>Champ obligatoire non rempli. :</p>
        </div>
