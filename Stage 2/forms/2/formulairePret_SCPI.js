...
////////////////////////////////////////gestion de demande de recherche de biens
    $('.aaa').change(function() {
        var compromis = $('input[type=radio][name=compromis]:checked').attr('value');
        // console.log(achat);
        if (compromis === 'choix en etude' || compromis === 'A determiner') {
            $('.recherche').css("display", "inline-block");

        }
         else if (compromis === 'choix en etude'|| compromis ==='A determiner') {
            $('.recherche').css("display", "inline-block");
