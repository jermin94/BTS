...
<html>
    ...
    <script>
        ...
        function submitForm() {
            $.ajax({type:'POST', url: 'modif_prestationn.php', data:$('#ContactForm').serialize(), success: function(response) {
 ...
 <form autocomplete="off" method="post" action="modif_prestationn.php" id="ContactForm" onsubmit="return submitForm();">
 
            <h1>Modifier prestation</h1><br/>
         <label for="id_presta"> code prestation</label>
         <input type="text" id="id_presta" name="id_presta" /><br/><br/>
